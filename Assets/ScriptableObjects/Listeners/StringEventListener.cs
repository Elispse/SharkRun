...
{
	[SerializeField] private StringEvent _event = default; // The FloatEvent to subscribe to.
	public UnityEvent<string> listener; // The UnityEvent<float> to invoke in response to the FloatEvent.
